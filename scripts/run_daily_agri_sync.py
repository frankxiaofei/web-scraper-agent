...
logger = logging.getLogger("run_daily_agri_sync")

SCHEDULE_PATH = ROOT / "config" / "schedule.yaml"


async def main() -> None:
    parser = argparse.ArgumentParser(description="每日智慧农业招标全站同步")
    ...
    parser.add_argument("--dry-run", action="store_true", help="同 --site-id，默认 crec_bidding")
