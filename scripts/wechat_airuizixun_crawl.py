...
也可通过标准同步管道触发：POST /api/sync/wechat_airuizixun/trigger
"""
...
# 兼容旧脚本常量
NICKNAME = "艾瑞咨询"
SITE_ID = "wechat_airuizixun"
ACCOUNT_ID = SITE_ID
KNOWN_START_URL = "https://mp.weixin.qq.com/s/oUW03pgDxtw8hGR3QrUO5A"
