...
也可通过标准同步管道触发：POST /api/sync/wechat_lpfb/trigger
"""
...
SITE_ID = "wechat_lpfb"
ACCOUNT_ID = SITE_ID
KNOWN_START_URL = "https://mp.weixin.qq.com/s/6GCakUX3m0qYEMtDtSK8_g"


def save_to_db(doc: dict, dry_run: bool = False) -> bool:
    """通过本地 API 保存到 notices 集合（公告列表可见）。"""
    if dry_run:
