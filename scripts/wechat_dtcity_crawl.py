...
也可通过标准同步管道触发：POST /api/sync/wechat_dtcity/trigger
"""
...
# 兼容旧脚本常量
NICKNAME = "数字孪生城市"
SITE_ID = "wechat_dtcity"
ACCOUNT_ID = SITE_ID
KNOWN_START_URL = "https://mp.weixin.qq.com/s/ibQcucCuhnSjAHJ9gei6_Q"
